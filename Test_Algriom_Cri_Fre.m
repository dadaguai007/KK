...
F1=[40e3,400e3,4000e3];
F2=[60e3,450e3,4500e3];
for mm=1:length(F1)
...
BER=[ber_total(1,:);ber_total_iter(1,:);...
    ber_total(2,:);ber_total_iter(2,:);...
    ber_total(3,:);ber_total_iter(3,:)];
LengendArrary=["80km w/o 40k","80km w SIC 40k",...
    "80km w/o 400k","80km w SIC 400k",...
    "80km w/o 4000k","80km w SIC 4000k"];
