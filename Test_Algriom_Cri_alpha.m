...
figure;hold on;
plot(alpha,ber_total(1,:))
plot(alpha,ber_total_iter(2,:))
plot(alpha,ber_total_iter_Group(2,:))
legend('基准','Total','Group')
...
LengendArrary=["80km w/o 0%Vpi",...
    "80km w/o 2%Vpi","80km w SIC 2%Vpi","80km w SIC Group 2%Vpi"];
berplot.multiplot(alpha,BER,LengendArrary);