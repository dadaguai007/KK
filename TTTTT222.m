...
% 文件存储路径
% datapath='Output\SSFM_80km_SIC_best_alpha_No_best_signal_400k';
datapath='Output\SSFM_80km_SIC_best_alpha_400k';
% 装载数据保存模块
...
for index=1:length(Eb_N0_dB)
    ...
    % 算法迭代
%     alpha=0.025;
    alpha=   0.4256; % 最佳alpha值  0.2041, 0.4256
    for j=1:1

        [recoverI,error]=iteraElimateF(re_signal+Dc,pd_input,fs,alpha,Dc,Vdither(1),f1,f2);
